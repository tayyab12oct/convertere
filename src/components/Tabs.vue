        ...
        <div class="flex items-start" v-bind:class="{
          ...
          block: openTab === 3,
            ...
            <p class="pr-7 text-gray-600 md:text-xl text-md">Do wizyty w komorze normobarycznej nie trzeba się
                ...
                Jedyny dyskomfort związany z przygotowaniem do pobytu w komorze jest związany z adaptacją naszego
                organizmu do zwiększającego się ciśnienia. Tu należy wspomnieć co to za dyskonfort!!!!.</p>
            <div class="hidden md:flex">
                <div class="md:w-46 w-20"><img src="../assets/przy.png" alt="" class="w-46" /></div>
            </div>
        </div>
