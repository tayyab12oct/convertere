<template>
  <footer class="bg-primary-100">
    <div class="lg:px-12 px-5 md:py-8 pb-4 pt-10 max-w-6xl w-full mx-auto text-gray-400">
      ...
      <p className="text-sm text-gray-700 font-normal text-center md:text-left pb-4">Wszelkie prawa zastrzeżone ©</p>
    </div>
  </footer>
</template>
